...
function LoginCaptian() {

  const {setcaptain, capLogin, setcaplogin} = useContext(captainContext)
    ...
    >
      ...
      <div className="w-full max-w-lg bg-white/90 rounded-lg p-8">
        ...
        <p className="text-sm py-4 text-red-700">
          New user ?{" "}
          <Link to={"/signup-captain"} className="hover:text-blue-600">
            Sign up
          </Link>
        </p>
      </div>
